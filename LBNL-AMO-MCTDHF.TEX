...
\item{There are options for a complex absorbing potential, CAP.}
\item{There is also an attempt at smooth complex scaling, now, for \verb#chmcthdf_sinc#, in which the $x$, $y$, and $z$
coodinates are separately scaled; you can make the coordinates real at the nuclei.  It does not perform well, however.}
\end{itemize}
}
%
