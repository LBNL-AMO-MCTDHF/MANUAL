...
v1.28 generalized fock eigenfunctions for orbital resolution for restricted
   configuration spaces for excited states for overlaps (action 20) with
   improvedfockflag.ne.0
