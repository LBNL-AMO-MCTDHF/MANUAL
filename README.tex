...
FACTOR OF 1/3 REMOVED FROM PHOTOIONIZATION (Actions 16,17)
RESULTS WILL BE 3x GREATER NOW  v1.16  BEWARE !!!
...
ALSO v1.16 parconsplit.ne.0 attempted and debugged first time.  Total
   MPI parallelization of LBNL-AMO-MCTDHF calculation possible with
